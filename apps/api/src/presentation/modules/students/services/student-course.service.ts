        ...
        chapters: course.chapters.map((ch) => ({
          ...
          lessons: ch.lessons.map((l) => ({
            ...
            videos: l.videos.map((video) => ({
              id: video.id,
              title: video.title,
              url: video.url || video.sourceKey || '',
              source: video.source,
              thumbnailUrl: video.thumbnailUrl,
              transcodingStatus: video.sourceKey?.startsWith('uploads/videos/') || (video.source && video.url) ? 'READY' : video.transcodingStatus,
              processingError: video.sourceKey?.startsWith('uploads/videos/') ? null : video.processingError,
            })),
